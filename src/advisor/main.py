...
def main(argv=sys.argv[1:]):
    ...
    report = report_factory.createReport(args.root, branch=args.branch, target_os=args.target_os, issue_type_config=args.issue_types, output_format=args.output_format)
